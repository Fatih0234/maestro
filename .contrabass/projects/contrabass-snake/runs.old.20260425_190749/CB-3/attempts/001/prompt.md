...
## Issue: Show a game over message

**Description:**
When the snake dies, display a centered 'Game Over' message on the canvas. Keep the existing controls and gameplay behavior unchanged.
